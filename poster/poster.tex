...
\vspace*{0.2cm}
            ...
            \begin{block}{Sum-Product Networks}
              ...
              \begin{figure}[h]
                \includegraphics[scale=0.38]{spn_1.png}
                \includegraphics[scale=0.38]{spn_2.png}
...
\vspace*{0.2cm}
            ...
            \justifying
              ...
              \begin{figure}[h]
                \includegraphics[scale=0.32]{completions/plane0.png}
                \includegraphics[scale=0.32]{completions/face0.png} \\
                \includegraphics[scale=0.32]{completions/stop0.png}
                \includegraphics[scale=0.32]{completions/dollar0.png}
