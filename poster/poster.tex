...
\vspace*{0.2cm}
            \begin{block}{Motivação}
              ...
              nas variáveis de uma distribuição de número exponencial de termos (ou seja, não
              compacta) como
            ...
            \begin{block}{Sum-Product Networks}
              ...
              \begin{itemize}
                ...
                \item $w_iS_i(X_\alpha)+w_jS_j(X_\beta)$ é uma SPN válida se $\alpha=\beta$ e pesos
                  $w_i,w_j\geq0$.\hfill\small{(Completude)}
                \item \normalsize{$S_i(X_\alpha) \cdot S_j(X_\beta)$ é uma SPN válida se}
                  $\alpha\cap\beta=\emptyset$.\hfill\small{(Consistência)} \\~\\
              \end{itemize}
              ...
              \begin{figure}[h]
                \includegraphics[scale=0.397]{spn_1.png}
                \includegraphics[scale=0.397]{spn_2.png}
              ...
              \begin{spn-thm} Uma SPN $S$ é válida se $S$ e toda sub-SPN de $S$ é completa e
                consistente.\\~\\
              \end{spn-thm}

              Existem SPNs que não são válidas, mas SPNs válidas são desejáveis pois computam
              $P(x_1,...,x_n)$ em tempo linear em seu tamanho, além de completude e consistência
              permitirem que a inferência da SPN seja garantidamente eficiente.
\vspace*{0.2cm}
            \end{block}
\vspace*{0.2cm}
